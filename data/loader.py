...
class NISTDataLoader:
    ...
    async def initialize(self) -> None:
        ...
        if missing_files:
            ...
            logger.info("Run 'python scripts/download_nist_data.py' to download required data")
    ...
    async def load_csf(self, force_reload: bool = False) -> Dict[str, Any]:
        ...
        logger.info(f"Loaded CSF with {len(self._csf_cache.get('functions', []))} functions")
        return self._csf_cache
    ...
    async def load_control_mappings(self, force_reload: bool = False) -> Dict[str, Any]:
        ...
        logger.info(f"Loaded {len(self._mappings_cache.get('mappings', {}))} control mappings")
        return self._mappings_cache
    ...
    def get_control_by_id(self, controls_data: Dict[str, Any], control_id: str) -> Optional[Dict[str, Any]]:
    ...
    def get_controls_by_family(self, controls_data: Dict[str, Any], family: str) -> List[Dict[str, Any]]:
