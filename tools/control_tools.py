...
class ControlTools:
        ...
        for control in matches:
            ...
            if parts:
                ...
                if prose:
                    ...
                    result["snippet"] = prose[:200] + "..." if len(prose) > 200 else prose
    ...
    def _get_family_info(self, family: str) -> Dict[str, str]:
        ...
        families = {
            "AC": {"name": "Access Control", "description": "Controls for limiting system access"},
            "AU": {"name": "Audit and Accountability", "description": "Controls for system auditing"},
            "AT": {"name": "Awareness and Training", "description": "Security awareness and training"},
            "CM": {"name": "Configuration Management", "description": "System configuration controls"},
            "CP": {"name": "Contingency Planning", "description": "Emergency response planning"},
            "IA": {"name": "Identification and Authentication", "description": "User identity management"},
            "IR": {"name": "Incident Response", "description": "Security incident handling"},
            "MA": {"name": "Maintenance", "description": "System maintenance controls"},
            "MP": {"name": "Media Protection", "description": "Storage media protection"},
            "PE": {"name": "Physical and Environmental Protection", "description": "Physical security"},
            ...
            "RA": {"name": "Risk Assessment", "description": "Risk management controls"},
            "CA": {"name": "Assessment, Authorization, and Monitoring", "description": "Security assessment"},
            "SC": {"name": "System and Communications Protection", "description": "System security"},
            "SI": {"name": "System and Information Integrity", "description": "Information integrity"},
            "SA": {"name": "System and Services Acquisition", "description": "Acquisition security"},
            "PM": {"name": "Program Management", "description": "Security program management"}
        }
        
        return families.get(family.upper(), {"name": f"{family.upper()} Family", "description": ""})
