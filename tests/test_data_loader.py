...
class TestNISTDataLoader:
    ...
    async def test_load_controls_from_json(self):
        ...
        with patch('aiofiles.open', mock_open(read_data=json.dumps(sample_data))), \
                ...
                "controls": [
                    {
                        ...
                        "parts": [{"prose": "The organization develops access control policies"}]
                    },
                    {
                        "id": "AU-1", 
                        "title": "Audit Policy",
                        "parts": [{"prose": "The organization develops audit policies"}]
                    }
                ]
            }
        }
