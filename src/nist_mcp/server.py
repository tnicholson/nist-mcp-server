...
@app.tool()
async def search_controls(query: str, family: str = None, limit: int = 10) -> Dict[str, Any]:
...
@app.tool()
async def search_csf_subcategories(query: str, function: str = None) -> Dict[str, Any]:
...
async def analyze_control_coverage(control_ids: List[str]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "coverage_analysis": {
                family: {"count": count, "percentage": round((count / len(valid_controls)) * 100, 2)}
...
@app.tool()
async def gap_analysis(implemented_controls: List[str], target_baseline: str = "moderate") -> Dict[str, Any]:
...
@app.tool()
async def validate_oscal_document(document: Dict[str, Any], document_type: str = "catalog") -> Dict[str, Any]:
